    ...
    <div className="relative">
      ...
      <label htmlFor="search" className="relative block">
        <input
          ...
          type="text"
          className="px-10 py-4 max-sm:py-3 w-full bg-transparent border-none text-white outline-none placeholder:text-slate-100/40 max-sm:focus:w-screen max-sm:focus:bg-sky-900 duration-1000 rounded-t-lg max-sm:focus:ring-2 max-sm:focus:ring-amber-900 max-sm:focus:border-amber-900"
      ...
      {/* Search Results */}
      <div className="absolute max-sm:w-96 z-10 bg-sky-900 w-full border-b max-sm:border-none border-slate-400  shadow-md">
